...
plt.figure(3)
plt.hold(True)
plt.plot(omegaAeros,omegaAeros,'o-',label='omega_aero')
plt.plot(omegaAeros,omegaRoots1,'o-',label='omega_root_1')
plt.plot(omegaAeros,omegaRoots2,'o-',label='omega_root_2')
plt.plot(omegaAeros,omegaRoots3,'o-',label='omega_root_3')
plt.plot(omegaAeros,omegaRoots4,'o-',label='omega_root_4')
plt.legend(loc=2)
plt.ylim([0,20000])
plt.xlim([0,25000])
...
plt.figure(4)
plt.hold(True)
plt.plot(omegaAeros,gammas1,'o-',label='gamma_root_1')
plt.plot(omegaAeros,gammas2,'o-',label='gamma_root_2')
plt.plot(omegaAeros,gammas3,'o-',label='gamma_root_3')
plt.plot(omegaAeros,gammas4,'o-',label='gamma_root_4')
plt.legend(loc=3)
plt.ylim([-1,.1])
plt.xlim([0,25000])
plt.xlabel('Aerodynamic frequency, rad')
